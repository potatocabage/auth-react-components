...
function ParentPermissionConfirm(props) {
    ...
    return (_jsx(SimpleLayout, Object.assign({ branding: props.branding }, { children: _jsx("div", Object.assign({ className: "h-100 w-100 d-flex" }, { children: _jsx(Card, Object.assign({ className: "mx-auto my-auto" }, { children: _jsxs(Card.Body, { children: [_jsx(Card.Title, { children: "Parent Permission" }, void 0), email !== null
                            ? _jsx(Card.Text, { children: "Thank you, your response has been noted." }, void 0)
                            : _jsx(CreateEmail, { tosUrl: props.branding.tosUrl, verificationChallengeKey: ((_a = new URLSearchParams(window.location.search).get("verificationChallengeKey")) !== null && _a !== void 0 ? _a : "")
