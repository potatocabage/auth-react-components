...
function RegisterForm(props) {
    const onSubmit = (values, fprops) => __awaiter(this, void 0, void 0, function* () {
        ...
        const maybeApiKey = yield userNew({
